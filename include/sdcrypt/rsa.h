...
int sdc_rsa_pubkey_init(sdc_rsa_pubkey_t *pubkey, sdc_word_t e, const uint8_t *n, size_t n_len);
...
int sdc_rsa_keypair(sdc_rsa_pubkey_t *pubkey, sdc_rsa_privkey_t *privkey, size_t bits);
#endif
